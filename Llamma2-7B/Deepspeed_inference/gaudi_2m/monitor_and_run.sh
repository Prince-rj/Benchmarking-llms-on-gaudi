...
mpirun --allow-run-as-root -np 4 --bind-to core --map-by slot -x MASTER_ADDR=127.0.0.1 -x MASTER_PORT=29500 -x HABANA_VISIBLE_DEVICES=0,1,2,3 python "$PYTHON_SCRIPT"
