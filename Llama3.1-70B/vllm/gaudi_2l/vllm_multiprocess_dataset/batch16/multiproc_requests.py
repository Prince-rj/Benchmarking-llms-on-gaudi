...
MODEL_ID = "/mnt/weka/data/pytorch/llama3.1/Meta-Llama-3.1-70B-Instruct/"
OUTPUT_CSV = "alpaca_benchmark_results.csv"
POWER_LOG = "power_log.csv"
NUM_SAMPLES = 1024        # None → load all (≈52,002 samples)
BATCH_SIZE = 16           # run this many in parallel
MAX_TOKENS = 1024
# ----------------------------------------
